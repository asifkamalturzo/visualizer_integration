...
class InsertionSortTest(unittest.TestCase):
    ...
    def testCasel(self):
        ...
        OutputArray = list(insertionSort(inputArray))[0][0]
        #print ("Output: ", array)
    ...
    def testCase2(self):
        ...
        expectedOutputArray = []
        #print ("Input: ", input_array)
        OutputArray = list(insertionSort(inputArray))
        #print ("Output: ", array)
        self.assertEqual(expectedOutputArray, OutputArray)
    ...
    def testCase5(self):
        ...
        expectedOutputArray = [0, 1, 3, 4, 8, 54, 67, 78]
        #print ("Input: ", expectedOutputArray)
        #input array is modified by insertionSort
        list(insertionSort(inputArray))
