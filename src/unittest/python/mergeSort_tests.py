...
class MergeSortTest(unittest.TestCase):
    ...
    def testCasel(self):
        ...
        OutputArray = list(mergeSort(inputArray, 0, len(inputArray)-1))[0][0]
        #print ("Output: ", array)
    ...
    def testCase2(self):
        ...
        expectedOutputArray = []
        #print ("Input: ", input_array)
        OutputArray = list(mergeSort(inputArray, 0, len(inputArray)-1))
        #print ("Output: ", array)
        self.assertEqual(expectedOutputArray, OutputArray)
    ...
    def testCase5(self):
        ...
        expectedOutputArray = [0, 1, 3, 4, 8, 54, 67, 78]
        #print ("Input: ", expectedOutputArray)
        #input array is modified by mergeSort
        list(mergeSort(inputArray, 0, len(inputArray)-1))
