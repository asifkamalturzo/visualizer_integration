...
class QuickSort_LRTest(unittest.TestCase):
    #testCasel - unsorted array 
    def testCasel(self):
        inputArray = [3, 67, 4, 1, 8, 0, 54, 78]
        expectedOutputArray = [0, 1, 3, 4, 8, 54, 67, 78]
        #print ("Input: ", input_array)
        OutputArray = list(quickSort_LR(inputArray, 0, len(inputArray)-1))[0][0]
        #print ("Output: ", array)
    ...
    def testCase2(self):
        ...
        expectedOutputArray = []
        #print ("Input: ", input_array)
        OutputArray = list(quickSort_LR(inputArray, 0, len(inputArray)-1))
        #print ("Output: ", array)
        self.assertEqual(expectedOutputArray, OutputArray)
    ...
    def testCase5(self):
        ...
        expectedOutputArray = [0, 1, 3, 4, 8, 54, 67, 78]
        #print ("Input: ", expectedOutputArray)
        #input array is modified by quickSort_LR
        list(quickSort_LR(inputArray, 0, len(inputArray)-1))
